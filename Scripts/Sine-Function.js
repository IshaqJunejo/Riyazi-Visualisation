...
function updateValues()
{
    ...
    output_2.innerHTML = Math.round(Math.sin(angle * Math.PI / 180) * 1000) / 1000;
...
function drawWave()
{
    ...
    {
        let y0 = Math.sin((i -1) * Math.PI / 180) * factorY * -0.5 + canvas_1.height / 2;
        let y1 = Math.sin(i * Math.PI / 180) * factorY * -0.5 + canvas_1.height / 2;
