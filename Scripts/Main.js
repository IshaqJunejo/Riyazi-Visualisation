...
let output_1 = document.querySelector("#value-perp");
let output_2 = document.querySelector("#value-base");
let output_3 = document.querySelector("#value-perp-2");
let output_4 = document.querySelector("#value-base-2");
...
// Updating Slider Value everytime they are moved
