...
function drawGridWave()
{
    ...
    // Angle Numbers on X-Axis of Grid
    for (let i = 1; i < 8; i++)
    {
...
function drawCircle()
{
    ...
    // The Dotted Line from Centre of Circle to Point of Circle (representing the angle)
    ctx_1.beginPath();
    ...
    // A 2 Pixels Radius Circle represent the Point of Circle
    ctx_1.strokeStyle = "#111";
    ...
    // The Vertical Line (Value) of the Circle
    ...
    // The Horizontal Line (Value) of the Circle
...
function drawWave()
{
    ...
    // The Vertical Dotted Line (representing the value of Angle)
